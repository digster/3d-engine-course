// engine/include/engine/gfx/framebuffer.hpp — a block of memory that is an image.
//
...
#include <engine/gfx/colour.hpp>   // pack_argb and friends: what a pixel's bits mean
