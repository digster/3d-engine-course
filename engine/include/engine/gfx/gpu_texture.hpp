// engine/include/engine/gfx/gpu_texture.hpp — an image on the device, and the object that reads it.
//
...
#include <engine/gfx/texture.hpp>   // engine::filter, engine::address_mode — Lesson 3.9
