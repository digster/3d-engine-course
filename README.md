...
**Status:** curriculum and conventions published; lessons in progress — **Modules 0–4 are complete**, **Module 5 is complete** — all 12 lessons, ~62 h, closed out of order by its checkpoint game — and **Module 6 is complete** — all 18 lessons, ~93 h, the longest module in the course — **Module 7 is complete** — all 8 lessons, ~47 h — and **Module 8 is under way** (**91 of 107**).
